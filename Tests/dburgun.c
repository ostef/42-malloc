...
#define TINY_ALLOC_MAX_SIZE FT_MALLOC_MAX_SMALL_SIZE
#define SMALL_ALLOC_MAX_SIZE FT_MALLOC_MAX_MID_SIZE
...
int main(void) {
    allocation_info allocations[ALLOC_COUNT] = {0};
