...
#define FT_MALLOC_SMALL_SIZE_GRANULARITY 32
#define FT_MALLOC_NUM_SMALL_SIZE_CLASS 50
...
#define FT_MALLOC_MID_SIZE_GRANULARITY 256
#define FT_MALLOC_NUM_MID_SIZE_CLASS 20
