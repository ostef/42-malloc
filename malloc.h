...
#define FT_MALLOC_NUM_SMALL_SIZE_CLASS 200
...
#define FT_MALLOC_MIN_MID_SIZE  (FT_MALLOC_MIN_SMALL_SIZE + FT_MALLOC_SMALL_SIZE_GRANULARITY * FT_MALLOC_NUM_SMALL_SIZE_CLASS)
#define FT_MALLOC_MAX_MID_SIZE (FT_MALLOC_MIN_MID_SIZE + FT_MALLOC_MID_SIZE_GRANULARITY * FT_MALLOC_NUM_MID_SIZE_CLASS)
